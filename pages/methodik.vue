    ...
    <div class="content">
      <div id="methode" class="wrapper">
        <section>
          ...
          <p>
            Die offiziellen Indikatoren wurden ausschließlich von der Deutschen Nachhaltigkeitsstrategie (DNS) übernommen.
            Die Deutsche Nachhaltigkeitsstrategie beurteilt die Indikatoren mit einem Wetterzeichen und zeigt so den Trend,
            ob sich der Indikator dem Zielwert nähert oder nicht. Wir von 2030Watch haben die Indikatoren in ein eigenes
            Bewertungssystem übersetzt, welches versucht, darzustellen, wie weit ein Indikator vom Ziel für 2030 entfernt ist.
          </p>
          <p>
            Auf der 2030Watch Seite werden hierzu weitere Indikatoren hinzugezogen, welche von der Zivilgesellschaft als
        ...
        <section>
          ...
          <ol>
            ...
            <li>
              Deutschland hat aus zivilgesellschaftlicher Sicht zu diesem Unterziel großen Handlungsbedarf.
              In Kommentaren von respektierten Organisationen wird ein Indikator zu diesem Thema gefordert.
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            ...
            <p class="formula">
              <img src="~assets/img/formula.svg" alt="Ausgangswert-Aktueller Wert/Ausgangswert-Zielwert" title="Formel zur Fortschrittsberechnung" />
            </p>
        ...
        <section>
          ...
          <p>
            Der Fortschritt auf Seiten der Deutschen Nachhaltigkeitsstrategie (DNS) wird mit einem Mittelwert
            von allen Indikatorenwerten pro jeweiligem SDG berechnet.
          </p>
          <p>
            Der Fortschritt auf der Seite von 2030Watch wird über den Mittelwert des jeweiligen erweiterten
            Indikatorenkataloges beziffert. Indikatoren, die als ungeeignet eingestuft wurden,
            fließen nicht in die Berechnung ein.
          </p>
          <p>
            Wichtig zu betonen, ist, dass wir nicht behaupten, diese Fortschrittsberechnung sei eine objektive Darstellung.
            Die Berechnungen sollen dazu dienen, einen Vergleich zwischen Nachhaltigkeitsbildern zu ermöglichen und
        ...
        <section>
          ...
          <p>
            Wir lehnen unsere Auswahl an gängige Vorgehen an, wie zum Beispiel das von
            <a href="http://www.sdgindex.org/" target="_blank">Sustainable Development Solutions Network</a> (SDSN).
            Sobald ein eindeutiger Ausgangswert in den Datenreihen gegeben ist, übernehmen wir diesen. Wenn dies nicht der Fall ist,
            wenden wir die Methode von <a href="http://www.sdgindex.org/" target="_blank">SDSN</a> an:
...
<script>
  export default {
    ...
    head () {
      return {
        title: 'Methodik | 2030Watch',
        meta: [
          { hid: 'description', name: 'description', content: 'Methodik' }
        ]
      }
    }
  }
