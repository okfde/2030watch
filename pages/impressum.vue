  ...
  <div class="page-container">
    <header class="inpage-header">
      <div class="wrapper">
        ...
        <section class="columns columns-gutter">
          <div>
            <p>Hier findest du unsere Kontaktdaten</p>
          </div>
        </section>
      </div>
    </header>
    ...
    <div class="content">
      ...
      <div class="wrapper">
        ...
        <h3>Urheberrecht</h3>
        <p>
          Die durch die Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht. Sie sind mit einer Creative Commons Lizenz urheberrechtlich geschützt. Sofern nicht anders angegeben, stehen die
      ...
      <div class="wrapper">
        ...
        <p>
          Die Sicherheit Ihrer Daten hat bei uns höchste Priorität. Wir ergreifen jede nur mögliche Maßnahme, um Ihre persönlichen Daten vor unbefugtem Zugriff zu schützen. Sämtliche Anforderungen des Bundesdatenschutzgesetzes (BDSG),
        ...
        <p>
          Personenbezogene Daten wie Name, Username und zusätzliche Metadaten wie z. B. Anschrift, Telefonnummer und E-Mail-Adresse (Bestandsdaten) werden erhoben, wenn und soweit dies im Rahmen der Begründung und Abwicklung eines
        ...
        <p>
          Die Website <a href="https://www.2030-watch.de">www.2030-watch.de</a> nutzt Matomo (<a href="https://matomo.org/">https://matomo.org/</a>), einen Open-Source-Webanalysedienst. Matomo verwendet sogenannte "Cookies", Textdateien, die auf Ihrem
          ...
          der Datenhoheit von <a href="https://www.2030-watch.de">www.2030-watch.de</a>. Wir benutzen diese Informationen, um die Nutzung auszuwerten und um Reports über die Websiteaktivitäten zusammenzustellen. OKF DE wird diese Informationen nicht an
          ...
          dieser Website voll umfänglich nutzen können. Durch die Nutzung dieser Website erklären Sie sich mit der Bearbeitung der über Sie erhobenen Daten durch <a href="https://www.2030-watch.de">www.2030-watch.de</a> in der zuvor beschriebenen Art und
          Weise und zu dem zuvor benannten Zweck einverstanden.
        </p>

        <h3>V. Newsletter</h3>
        <p>
          Bei Anmeldung zum E-Mail-Newsletter wird Ihre E-Mail-Adresse mit Ihrer Einwilligung für eigene Zwecke genutzt, bis Sie sich vom Newsletter abmelden. Eine Abmeldung ist jederzeit über den dafür vorgesehenen Link im Newsletter oder eine
        ...
        <p>
          Ihr Vertrauen ist uns wichtig. Daher möchten wir Ihnen jederzeit und kostenlos Rede und Antwort bezüglich der Verarbeitung Ihrer personenbezogenen Daten stehen. Auch haben Sie nach dem Bundesdatenschutzgesetz ein Recht auf
          ...
          href="mailto:2030-watch@okfn.de">2030-watch@okfn.de</a>.
        </p>
