  ...
  <div class="page-container">
    ...
    <div class="content">
      ...
      <div class="wrapper">
        ...
        <p>
          Die Open Knowledge Foundation Deutschland e.V., Singerstr. 109, 10179 Berlin Deutschland (nachfolgend als "Open Knowledge Foundation" oder "wir" bezeichnet) betreibt die im Internet unter https://www.2030-watch.de und den jeweils dazu gehörenden Unterverzeichnissen abrufbare Internetseite (nachfolgend "2030-watch.de" oder die "Website").
        </p>
        <p>
        ...
        <h4>3. Zwecke und Rechtsgrundlage der Datenverarbeitung</h4>
        <p>
        ...
        <ul class="imprint-liststyle">
          <li>
            <b>Art. 15 DS-GVO – Auskunftsrecht der betroffenen Person:</b> Sie haben das Recht, von uns eine Bestätigung darüber zu verlangen, ob Sie betreffende personenbezogene Daten verarbeitet werden und wenn ja, welche dies sind sowie die näheren Umstände der Datenverarbeitung.
          </li>
          <li>
            <b>Art. 16 DS-GVO – Recht auf Berichtigung:</b> Sie haben das Recht, von uns unverzüglich die Berichtigung Sie betreffender unrichtiger personenbezogener Daten zu verlangen. Dabei haben Sie unter Berücksichtigung der Zwecke der Verarbeitung auch das Recht, die Vervollständigung unvollständiger personenbezogener Daten – auch mittels einer ergänzenden Erklärung – zu verlangen.
          </li>
          <li>
            <b>Art. 17 DS-GVO – Recht auf Löschung:</b> Sie haben das Recht, von uns zu verlangen, dass Sie betreffende personenbezogene Daten unverzüglich gelöscht werden. Beachten Sie hier bitte die unter Punkt II. 4 beschriebene Ausnahme
          </li>
          <li>
            <b>Art. 18 DS-GVO – Recht auf Einschränkung der Verarbeitung:</b> Sie haben das Recht, von uns die Einschränkung der Verarbeitung zu verlangen.
          </li>
          <li>
            <b>Art. 20 DS-GVO – Recht auf Datenübertragbarkeit:</b> Sie haben das Recht, im Falle der Verarbeitung aufgrund einer Einwilligung oder zur Erfüllung eines Vertrags, die Sie betreffenden personenbezogenen Daten, die Sie uns bereitgestellt haben, in einem strukturierten, gängigen und maschinenlesbaren Format zu erhalten, und diese Daten einem anderen Verantwortlichen ohne Behinderung durch uns zu übermitteln oder die Daten direkt an den anderen Verantwortlichen übermitteln zu lassen, soweit dies technisch machbar ist.
          </li>
          <li>
            <b>Art. 21 DS-GVO – Widerspruchsrecht:</b> Sie haben das Recht, aus Gründen, die sich aus ihrer besonderen Situation ergeben, jederzeit gegen die Verarbeitung Sie betreffender personenbezogener Daten, die aufgrund eines berechtigten Interesses unsererseits oder zur Wahrung einer Aufgabe im öffentlichen Interesse erforderlich ist, oder die in Ausübung öffentlicher Gewalt erfolgt, Widerspruch einzulegen.
            <br />
          ...
          <li>
            <b>Art. 77 DSGVO i. V. m. § 19 BDSG – Recht auf Beschwerde bei einer Aufsichtsbehörde:</b> Sie haben das Recht, jederzeit Beschwerde bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat ihres Aufenthaltsorts, ihres Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes, einzulegen, wenn Sie der Ansicht sind, dass die Verarbeitung der sie betreffenden personenbezogenen Daten gegen geltendes Recht verstößt.
          </li>
        </ul>
